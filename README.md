...
curl -LO https://github.com/jjarndt/camunda-modeler-call-activity-navigator/releases/latest/download/camunda-modeler-call-activity-navigator-1.2.0.zip
unzip camunda-modeler-call-activity-navigator-1.2.0.zip && rm camunda-modeler-call-activity-navigator-1.2.0.zip
```
</details>
...
Invoke-WebRequest -Uri "https://github.com/jjarndt/camunda-modeler-call-activity-navigator/releases/latest/download/camunda-modeler-call-activity-navigator-1.2.0.zip" -OutFile "plugin.zip"
